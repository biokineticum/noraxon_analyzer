...
class ModuleTarget(QWidget):
    ...
    def init_ui(self):
        ...
        # 1. Load File
        group_load = QGroupBox("1. Load Extracted Event")
        ...
        group_map = QGroupBox("2. Column Mapping (if empty)")
        ...
        # 4. Summary Text
        group_summary = QGroupBox("Event Report")
        summary_layout = QVBoxLayout()
        self.lbl_summary = QLabel("Load file and click Analyze.")
    ...
    def load_file(self):
        ...
        self.lbl_summary.setText("Data loaded. Ready for analysis.")
        ...
        try:
            ...
            if 'resultant_force' in df.columns:
                ...
                summary_text += (
                    ...
                    f"Velocity X: {peak_vx:.2f} m/s\n"
                    f"Velocity Y: {peak_vy:.2f} m/s\n"
                    f"Velocity Z: {peak_vz:.2f} m/s\n"
                    f"Resultant Velocity: {peak_vel:.2f} m/s\n"
                )
